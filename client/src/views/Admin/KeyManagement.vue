<template>
  <div class="key-management">
    ...
    <!-- 新增/编辑密钥弹窗 -->
    <n-modal v-model:show="showKeyModal" preset="dialog" :title="editingKey ? '编辑密钥' : '新增密钥'" @update:show="(value) => { if (!value) handleKeyModalClose() }">
      <n-form ref="keyFormRef" :model="keyFormData" :rules="keyRules" label-placement="left" label-width="100px">
        ...
        <n-form-item label="API密钥" path="apiKey">
          <n-input
            v-model:value="keyFormData.apiKey"
            type="textarea"
